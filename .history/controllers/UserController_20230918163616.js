...
const Login = async (req,res)=>{
  try {
    ...
    if(token){  
      ...
      if(id){
        const User = await Users.findOne({where:{phoneNumber},atrributes:['fullName','gmail','phoneNumber'],include:[Cars]})
    ...
    const User = await Users.findOne({where:{phoneNumber},attributes:['fullName','gmail','phoneNumber'],include:[Cars]})
