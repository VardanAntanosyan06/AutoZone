...
const Login = async (req,res)=>{
  try {
    ...
    // if(token){
      const decoded = await jwt.verify("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoyLCJpYXQiOjE2OTQ3Nzc1Njh9.TC-MXzIajHviEYfECetxVgWgyRtuY1qNu4mCX4oefUE", process.env.JWT_SECRET);
